    ...
    Widget logoImageArea = new Container(
      ...
      child: Column(
        children: [
          ...
          new Container(
            child: Text("互助康",style: TextStyle(color: Color.fromRGBO(51, 51, 51, 1),fontSize: 32.0),),
            margin: EdgeInsets.only(top: 10.0),
          ),
          new Container(
            child: Text("助力健康中国·共同防癌",style: TextStyle(color: Color.fromRGBO(166, 166, 166, 1),fontSize: 18.0),),
